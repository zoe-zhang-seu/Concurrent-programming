...
public class Carousel {
    ...
    protected int compartmentCount = 5;
     ...
     */
    public Carousel(Scanner scanner) {
    ...
    public synchronized Vial getVial() throws InterruptedException {
    	...
    	System.out.println(vial + " [ c" + (scannerPos + 1) + " -> S  ]");
    ...
    public synchronized void handBack(Vial vial) throws InterruptedException {
    	...
    	System.out.print(indentation);
    	System.out.println(vial + " [  S -> c" + (scannerPos + 1) + " ]");
    ...
    public synchronized void rotate() 
        ...
        if (compartment[scannerPos] != null) {
