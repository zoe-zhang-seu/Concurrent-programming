...
public class InspectionCarouselDrive extends VaccineHandlingThread {

    // the carousel to be handled
    protected InspectionCarousel carousel;

    /**
     * Create a new CarouselDrive with a carousel to rotate.
     */
    public InspectionCarouselDrive(InspectionCarousel carousel) {
        super();
